            ...
            {activeTab === 'map' && (
              <div>
                <div className="flex gap-2 mb-4 overflow-x-auto pb-2">
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-semibold whitespace-nowrap text-sm transition ${
                      filter === 'all' ? 'bg-green-600 text-white shadow-md' : 'bg-white text-gray-700 border border-gray-200 hover:border-green-300'
                    }`}
                  >
                    All ({reports.length})
                  </button>
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-semibold whitespace-nowrap text-sm transition ${
                      filter === 'overflowing' ? 'bg-orange-500 text-white shadow-md' : 'bg-white text-gray-700 border border-gray-200 hover:border-orange-300'
                    }`}
                  >
                    Overflowing
                  </button>
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-semibold whitespace-nowrap text-sm transition ${
                      filter === 'illegal-dump' ? 'bg-red-500 text-white shadow-md' : 'bg-white text-gray-700 border border-gray-200 hover:border-red-300'
                    }`}
                  >
                    Illegal Dumps
                  </button>
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-semibold whitespace-nowrap text-sm transition ${
                      filter === 'litter' ? 'bg-yellow-500 text-white shadow-md' : 'bg-white text-gray-700 border border-gray-200 hover:border-yellow-300'
                    }`}
                  >
                    Litter
                  </button>
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 h-96 relative flex items-center justify-center border-2 border-green-100">
                    <div className="text-center p-6">
                      <MapPin className="w-16 h-16 text-green-500 mx-auto mb-4" />
                      <p className="text-gray-700 font-semibold text-lg mb-2">Interactive Map View</p>
                      <p className="text-sm text-gray-500 mb-4">
                        Showing {filteredReports.length} report{filteredReports.length !== 1 ? 's' : ''}
                      </p>
                      <div className="inline-block bg-white px-4 py-2 rounded-lg shadow text-sm text-gray-600">
                        💡 Real map integration with Leaflet coming in Step 13
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center justify-between text-sm flex-wrap gap-2">
                      <div className="flex gap-4 flex-wrap">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-700">Overflowing</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-3 h-3 bg-red-500 rounded-full"></div>
                          <span className="text-gray-700">Illegal Dump</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
                          <span className="text-gray-700">Litter</span>
                        </div>
                        <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-600 font-semibold">{filteredReports.length} locations</span>
                    </div>
                  </div>
                </div>
              </div>
